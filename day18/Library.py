...
class library:
    ...
    def check_self(self):
        ...
        for i in range(len(b)):
            if self.a["books"][b[i]]["type"] == "book":
                print(repr(book_types.book(self.a["books"][b[i]]["author"], self.a["books"][b[i]]["available"], b[i], self.a["books"][b[i]]["pages"])))
            elif self.a["books"][b[i]]["type"] == "ebook":
                print(repr(book_types.ebook(self.a["books"][b[i]]["author"], self.a["books"][b[i]]["available"], b[i], self.a["books"][b[i]]["pages"], self.a["books"][b[i]]["file_size_mb"])))
            elif self.a["books"][b[i]]["type"] == "audiobook":
                print(repr(book_types.audiobook(self.a["books"][b[i]]["author"], self.a["books"][b[i]]["available"], b[i], self.a["books"][b[i]]["file_size_mb"], self.a["books"][b[i]]["duration_mins"])))
    ...
    def display_clean_data(self):
        ...
        for i in range(len(b)):
            if self.a["books"][b[i]]["type"] == "book":
                print(book_types.book(self.a["books"][b[i]]["author"], self.a["books"][b[i]]["available"], b[i], self.a["books"][b[i]]["pages"]))
            elif self.a["books"][b[i]]["type"] == "ebook":
                print(book_types.ebook(self.a["books"][b[i]]["author"], self.a["books"][b[i]]["available"], b[i], self.a["books"][b[i]]["pages"], self.a["books"][b[i]]["file_size_mb"]))
            elif self.a["books"][b[i]]["type"] == "audiobook":
                print(book_types.audiobook(self.a["books"][b[i]]["author"], self.a["books"][b[i]]["available"], b[i], self.a["books"][b[i]]["file_size_mb"], self.a["books"][b[i]]["duration_mins"]))
    def display_sorted(self):
        c = []
        b = list(self.a["books"].keys())
        for i in range(len(b)):
            if self.a["books"][b[i]]["type"] == "book":
                c.append(book_types.book(self.a["books"][b[i]]["author"], self.a["books"][b[i]]["available"], b[i], self.a["books"][b[i]]["pages"]))
            elif self.a["books"][b[i]]["type"] == "ebook":
                c.append(book_types.ebook(self.a["books"][b[i]]["author"], self.a["books"][b[i]]["available"], b[i], self.a["books"][b[i]]["pages"], self.a["books"][b[i]]["file_size_mb"]))
        c = sorted(c)
        for i in range(len(c)):
            print(c[i])
